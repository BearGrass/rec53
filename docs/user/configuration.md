...
- `upstream_concurrency_limit`: global concurrent budget for outbound upstream work; `0` uses `runtime.NumCPU()`
...
- keep `upstream_concurrency_limit: 0` unless you have measured upstream saturation and need a different static gate
