...
README.md SHALL 在末尾包含文档索引，链接指向：`docs/architecture.md`、`docs/testing/benchmarks.md`、`docs/testing/README.md`、`docs/metrics.md`、`docs/dev/conventions.md`、`docs/roadmap.md`。
