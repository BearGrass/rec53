# domain-resolution-trace Specification

## Purpose
Define a bounded, request-scoped debugging flow for inspecting the real resolver path of a specified domain or query.
